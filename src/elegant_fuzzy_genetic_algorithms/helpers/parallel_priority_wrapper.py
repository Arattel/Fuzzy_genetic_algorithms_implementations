...
class ParallelPriorityWrapper:
    def __init__(self, n_terms_fitness: int = 3, n_processes: int = mp.cpu_count()) -> None:
        self.inferrers = [GeneralizedPriorityInferencer(n_terms_fitness=n_terms_fitness) for _ in range(n_processes)]
