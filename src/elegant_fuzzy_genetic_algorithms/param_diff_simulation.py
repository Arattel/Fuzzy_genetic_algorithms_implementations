...
def simulation_param_diff(N = 50, epochs: int =  100, verbose = False, default_params = Conf.default_params, conf: SimulationConfig = SimulationConfig(), fitness_fn = None, 
    ...
    priorities = list(map(lambda x: x[0], heap))
    # history.append(priorities)
    ...
    for i in tqdm(range(epochs)):
        ...
        params['best_fitness'] = best_fitness
        params['avg_fitness'] = avg_fitness
        params['avg_fit_change'] = avg_fit_change
